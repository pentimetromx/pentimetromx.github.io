...
var idsMA = ['toyota-kaizen','toyota-kaizen-antes','planos-kaizen','materiales-kaizen','kaizenCont','conti-boton-planos', 'conti-boton-kaizen','troubleshooting','canvasContainer2', 'contChecks', 'canvasContainer3', 'contImagNeg',,'contImagGraf','canvasContainer4','canvasContainer5','canvasContainer6','canvasContainer7','canvasContainer8', 'canvasContainer9'];
...
function rodillosKaizen(idButton,vidElem) {
  ...
  if (bton12 !== null) {
    ...
    console.error('El elemento con ID "btn12" no existe.');
}      
  switch(idButton){
    case 'btn10':
      ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      for (var i = 0; i < buttsToyota.length; i++) {                                                                        /// OBTENER 'window.getcomputedStyle'
...
function manejarClick() {
  ...
  // Verifica el número de clics y muestra el alert correspondiente
  if (contadorClicks === 1) {
    alert('Primer click');
  } else if (contadorClicks === 2) {
    alert('Segundo click');
    
    // Reinicia la variable contadorClicks después del segundo clic
    contadorClicks = 0;
  }
}
...
function transicionImagenes() {
  ...
  function ocultarSiguienteImagen() {
    ...
    if (index < buttsToyota.length) {
      ...
      setTimeout(ocultarSiguienteImagen, 300);
    } else {
